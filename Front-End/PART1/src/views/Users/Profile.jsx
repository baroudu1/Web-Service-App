...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (user.laboratory) setDep(user.laboratory)
        ...
        >
          <CCard style={{ width: '100%' }}>
            ...
            >
              ...
              />
              <h5 style={{ width: '100%', textAlign: 'center' }}>{name}</h5>
              <p style={{ width: '100%', textAlign: 'center' }}>{Email}</p>
              <p style={{ width: '100%', textAlign: 'center' }}>Phone: {Phone}</p>
              <p style={{ width: '100%', textAlign: 'center' }}>Departement: {Dep}</p>
            </CCardBody>
          </CCard>
        </div>
      </div>
